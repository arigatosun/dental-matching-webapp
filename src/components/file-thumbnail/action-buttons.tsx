  ...
  return (
    <ButtonBase
      sx={{
        ...
        '&:hover': {
          ...bgBlur({ color: varAlpha(theme.vars.palette.grey[900], 0.64) }),
          opacity: 1,
        },
        ...sx,
      }}
  ...
  return (
    <IconButton
      ...
      sx={{
        ...
        position: 'absolute',
        color: 'common.white',
        bgcolor: (theme) => varAlpha(theme.vars.palette.grey[900], 0.48),
        '&:hover': { bgcolor: (theme) => varAlpha(theme.vars.palette.grey[900], 0.72) },
        ...sx,
      }}
      {...other}
    >
