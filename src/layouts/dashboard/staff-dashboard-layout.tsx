...
import { _staffAccount } from '../config-staff-nav-account';
import { HeaderBase } from '../core/header-base';
import { LayoutSection } from '../core/layout-section';
import { navData as staffDashboardNavData } from '../config-satff-nav-dashboard';
...
export function StaffDashboardLayout({ sx, children, data }: StaffDashboardLayoutProps) {
  ...
  const navData = data?.nav ?? staffDashboardNavData;
            ...
            slots={{
              topArea: (
                <Alert severity="info" sx={{ display: 'none', borderRadius: 0 }}>
                  This is an info Alert for staff.
                </Alert>
              ),
